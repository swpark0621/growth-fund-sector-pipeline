...
- Big3 모니터링 컬럼은 BlackRock/iShares, Vanguard, State Street/SSGA/SPDR 명칭이 공개 institutional ownership 페이지에 잡히는지 확인합니다. Fintel SEC 신고 기반 데이터이므로 국내 전체 주주명부나 실시간 지분율은 아닙니다.
